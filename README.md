...
The **Museum With No Frontiers — Portraits** gallery, built from the published
dataset `@museumwnf/portraits-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/portraits-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/portraits/> through the reusable workflows in
