...
export default {
  ...
  home: {
    title: 'portraits.identity.title',
    intro: 'portraits.home.intro',
    cards: [
      {
        title: 'portraits.nav.catalogue',
        description: 'portraits.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'portraits.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'portraits.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'portraits.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'portraits.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'portraits.partnerObjects.emptyPartner',
  //         emptyInstitution: 'portraits.partnerObjects.emptyInstitution',
  //         institutionSummary: 'portraits.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'portraits.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'portraits.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
