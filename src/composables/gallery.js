...
// `useGalleryData.js` used to be byte-identical local copies of what portraits
...
// legacy project key, no UUID — portraits shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (portraits-data 1.0.11+), an outside
